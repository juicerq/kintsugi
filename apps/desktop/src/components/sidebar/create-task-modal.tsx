						...
						<div className="relative px-5 pt-5 pb-4 border-b border-white/[0.06]">
							<div className="flex items-center gap-2">
								<div className="relative">
									...
									<ListTodo className="relative size-4 text-white/45" />
								</div>
								...
								<div className="space-y-1.5">
									...
									<textarea
										...
										className={cn(
											...
											"focus-visible:outline-none focus-visible:border-white/20 focus-visible:ring-0 focus-visible:shadow-[0_0_0_1px_rgba(255,255,255,0.12),0_0_8px_rgba(255,255,255,0.04)]",
								...
								<div className="space-y-1.5">
									...
									<div className="flex gap-2">
										...
										<Input
											...
											disabled={isSubmitting}
											className="flex-1 h-7 text-[12px] bg-white/[0.03] border-white/[0.08] transition-shadow duration-200 focus-visible:border-white/20 focus-visible:ring-0 focus-visible:shadow-[0_0_0_1px_rgba(255,255,255,0.12),0_0_8px_rgba(255,255,255,0.04)]"
										/>
									</div>
									{fullBranchName && (
