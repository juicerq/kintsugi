					...
					>
						...
						<div className="px-5 pt-5 pb-4 border-b border-white/[0.06]">
							<div className="flex items-center gap-2">
								<ListTodo className="size-4 text-white/40" />
								...
								<div className="space-y-1.5">
									...
									<textarea
										...
										className={cn(
											...
											"focus-visible:outline-none focus-visible:border-white/20 focus-visible:ring-1 focus-visible:ring-white/10",
								...
								<div className="space-y-1.5">
									...
									<div className="flex gap-2">
										...
										<Input
											...
											disabled={isSubmitting}
											className="flex-1 h-7 text-[12px] bg-white/[0.03] border-white/[0.08] focus-visible:border-white/20 focus-visible:ring-white/10"
										/>
									</div>
									{fullBranchName && (
